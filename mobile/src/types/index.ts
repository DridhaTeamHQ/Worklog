...
export interface ChatContact { id: number; name: string; email: string; profile_image: string | null; department: string | null; unread: number; last_message?: string | null; last_message_at?: string | null; }
export interface ChatMessage { id: number; sender_id: number; recipient_id: number; body: string; read_at: string | null; created_at: string; sender_name?: string; }
export interface TeamMessage { id: number; sender_id: number; body: string; created_at: string; sender_name?: string; }
export interface ChatGroup { id: number; name: string; member_count: number; members?: { id: number; name: string; profile_image: string | null }[]; last_message?: string | null; unread: number; }
export interface GroupMessage { id: number; group_id: number; sender_id: number; body: string; created_at: string; sender_name?: string; }
export interface ChatUnread { unread: number; direct: number; threads: { user_id: number; unread: number }[]; team: { unread: number; mentions: number }; groups: number; }
