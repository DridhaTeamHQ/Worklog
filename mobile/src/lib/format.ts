...
/** '1h 30m' / '45m' — how long a report line or a day took. */
...
/** 'Mon 4 Sep' — the short heading a phone has room for. */
...
export const firstName = (name: string | null | undefined) => String(name || '').trim().split(/\s+/)[0] || 'there';
