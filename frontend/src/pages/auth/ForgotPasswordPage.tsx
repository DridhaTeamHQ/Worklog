    ...
    <div className="flex min-h-screen items-center justify-center bg-muted px-5 py-10">
      <div className="w-full max-w-md">
        ...
        <div className="card p-6 sm:p-8">
          {error && (
            <div className="mb-5 flex items-start gap-2.5 rounded-lg border border-primary/25 bg-primary/10 px-3.5 py-3" role="alert">
          ...
          {stage === 'request' && (
            <>
              <h1 className="display-title text-2xl text-foreground">Forgot your password?</h1>
          ...
          {stage === 'sent' && (
            <div className="text-center">
              <span className="mx-auto mb-4 inline-flex h-14 w-14 items-center justify-center rounded-full bg-success/10 text-success">
                <MailCheck className="h-7 w-7" />
              </span>
              <h1 className="display-title text-2xl text-foreground">Check your inbox</h1>
          ...
          {stage === 'reset' && (
            <>
              <h1 className="display-title text-2xl text-foreground">Set a new password</h1>
              <p className="mt-1.5 text-sm text-muted-foreground">
          ...
          {stage === 'done' && (
            <div className="text-center">
              ...
              <h1 className="display-title text-2xl text-foreground">Password updated</h1>
              <p className="mt-2 text-sm text-muted-foreground">{message}</p>
