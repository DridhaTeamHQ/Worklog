  ...
  return (
    ...
    >
      <form id="edit-member-form" onSubmit={submit} className="space-y-4" noValidate>
        <div>
          <label className="label" htmlFor="e-name">Full name <span className="text-red-500">*</span></label>
          <input
            id="e-name"
            value={name}
        ...
        <div>
          <label className="label" htmlFor="e-email">Work email <span className="text-red-500">*</span></label>
          <input
            id="e-email"
            type="email"
            value={email}
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className="label" htmlFor="e-dept">Department <span className="text-red-500">*</span></label>
            <input
              id="e-dept"
              value={department}
          ...
          <div>
            <label className="label" htmlFor="e-title">Job title <span className="text-red-500">*</span></label>
            <input
              id="e-title"
              value={jobTitle}
        ...
        <label className="flex items-start gap-3 rounded-lg border border-ink-200 bg-ink-50 px-4 py-3">
          ...
          <span className="min-w-0">
            <span className="block text-sm font-semibold text-ink-900">Account is active</span>
